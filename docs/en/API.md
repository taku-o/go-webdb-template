...
This API conforms to OpenAPI 3.0/3.1 specification. You can retrieve the OpenAPI specification from the following endpoints:
...
- **Echo v4**: High-performance HTTP router
- **Huma v2**: OpenAPI specification auto-generation and validation
...
API rate limiting is implemented. Limits requests per IP address.

See [Rate-Limit.md](Rate-Limit.md) for details.
