...
#### - [x] タスク 1.1: RedisClusterConfig構造体に接続オプションフィールドを追加
...
#### - [x] タスク 1.2: RedisSingleConfig構造体に接続オプションフィールドを追加
...
#### - [x] タスク 1.4: staging環境の設定ファイルに接続オプション設定を追加
...
#### - [x] タスク 1.5: production環境の設定ファイルに接続オプション設定を追加
...
#### - [x] タスク 2.1: initStore関数の1箇所目で接続オプションを設定
...
#### - [x] タスク 2.2: initStore関数の2箇所目で接続オプションを設定
...
#### - [x] タスク 3.1: NewClient関数で接続オプションを設定
...
#### - [x] タスク 3.2: NewServer関数で接続オプションを設定
...
#### - [x] タスク 4.1: docker-compose.redis.ymlの確認
...
#### - [x] タスク 4.2: scripts/start-redis.shの確認
...
#### - [x] タスク 4.3: config/{env}/cacheserver.yamlの確認
**目的**: 既存の設定ファイルを確認する
...
#### - [x] タスク 4.4: config/{env}/config.yamlの確認
