...
#### - [ ] タスク 1.2: シャーディングデータベース1のスキーマ変更（users）
...
#### - [ ] タスク 1.3: シャーディングデータベース1のスキーマ変更（posts）
...
#### - [ ] タスク 1.4: シャーディングデータベース2のスキーマ変更（users）
...
#### - [ ] タスク 1.5: シャーディングデータベース2のスキーマ変更（posts）
...
#### - [ ] タスク 1.6: シャーディングデータベース3のスキーマ変更（users）
...
#### - [ ] タスク 1.7: シャーディングデータベース3のスキーマ変更（posts）
...
#### - [ ] タスク 1.8: シャーディングデータベース4のスキーマ変更（users）
...
#### - [ ] タスク 1.9: シャーディングデータベース4のスキーマ変更（posts）
...
#### - [ ] タスク 2.1: ValidateTableName関数の許可リスト更新
...
#### - [ ] タスク 3.1: UserモデルのTableNameメソッド変更
...
#### - [ ] タスク 3.2: PostモデルのTableNameメソッド変更
...
#### - [ ] タスク 3.3: NewsモデルのTableNameメソッド変更
...
#### - [ ] タスク 4.1: UserRepositoryのテーブル名参照変更
...
#### - [ ] タスク 4.2: UserRepositoryGORMのテーブル名参照変更
...
#### - [ ] タスク 4.3: PostRepositoryのテーブル名参照変更
...
#### - [ ] タスク 4.4: PostRepositoryGORMのテーブル名参照変更
...
#### - [ ] タスク 4.5: NewsRepositoryのテーブル名参照変更
...
#### - [ ] タスク 4.6: NewsRepositoryGORMのテーブル名参照変更
...
#### - [ ] タスク 5.1: テストユーティリティのスキーマ作成SQL変更
...
#### - [ ] タスク 5.4: Repositoryテストファイルのファイル名変更
