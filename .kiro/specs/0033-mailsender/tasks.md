...
#### - [x] タスク 1.3: MailpitのDocker Compose設定を作成
...
#### - [x] タスク 2.1: EmailSenderインターフェースの定義
...
#### - [x] タスク 5.2: EmailServiceの初期化をmain.goに追加
...
#### - [x] タスク 9.2: MailpitSenderのユニットテスト
...
#### - [x] タスク 9.4: EmailServiceのユニットテスト
...
#### - [x] タスク 9.5: TemplateServiceのユニットテスト
