...
#### - [ ] タスク 1.1: server/cmd/server/main.goのPingAll()呼び出し削除
...
#### - [ ] タスク 2.1: server/internal/db/connection.goのNewConnection関数のPing削除
...
#### - [ ] タスク 4.1: docker-compose.postgres.ymlの作成
...
#### - [ ] タスク 4.2: scripts/start-postgres.shの作成
...
#### - [ ] タスク 5.1: avast/retry-go/v4ライブラリの導入
...
#### - [ ] タスク 5.3: NewConnection関数へのリトライ機能追加
...
#### - [ ] タスク 5.4: NewGORMConnection関数へのリトライ機能追加
...
#### - [ ] タスク 7.3: 開発環境のデータベース設定をSQLite版に戻す
