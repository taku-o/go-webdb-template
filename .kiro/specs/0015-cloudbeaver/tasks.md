...
#### - [ ] タスク 1.1: CloudBeaver設定ディレクトリの作成
...
#### - [ ] タスク 1.2: Resource Manager用ディレクトリの作成
...
#### - [ ] タスク 3.1: cloudbeaver-start.shスクリプトの作成
...
#### - [ ] タスク 4.2: CloudBeaver起動確認（ステージング環境）
