...
#### - [x] タスク 2.1: docker-compose.cloudbeaver.ymlの作成
...
#### - [x] タスク 3.1: docker-compose.metabase.ymlの作成
...
#### - [x] タスク 4.1: metabase-start.shスクリプトの作成
...
#### - [x] タスク 4.2: cloudbeaver-start.shスクリプトの更新
...
#### - [x] タスク 6.3: CloudBeaver起動確認（docker-compose.cloudbeaver.yml使用）
...
#### - [x] タスク 6.4: CloudBeaverとMetabaseの個別起動確認
...
#### - [x] タスク 7.1: Metabase起動確認（ステージング環境）
