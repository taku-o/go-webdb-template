...
func main() {
	...
	app.HandleFunc("/admin/dm_user/register", gorillaAdapter.Content(func(ctx gorillaAdapter.Context) (types.Panel, error) {
		return pages.UserRegisterPage(goadminContext.NewContext(ctx.Request), groupManager)
	})).Methods("GET", "POST")
	app.HandleFunc("/admin/dm_user/register/new", gorillaAdapter.Content(func(ctx gorillaAdapter.Context) (types.Panel, error) {
